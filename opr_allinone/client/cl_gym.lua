    ...
    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'gym_shop_menu',
        {
            ...
            elements = {
				...
				{label = 'Water ($40)', value = 'water'},
				{label = 'Sportlunch ($150)', value = 'sportlunch'},
				{label = 'Powerade ($500)', value = 'powerade'},
            }
        },
        function(data, menu)
...
function OpenGymShipMenu()
    ...
    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'gym_ship_menu',
        {
            ...
            elements = {
				{label = 'Membership ($1000)', value = 'membership'},
            }
        },
        function(data, menu)
...
function OpenBikeMenu()
    ...
    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'bike_menu',
        {
            title    = 'Hire a bike',
            elements = {
				{label = 'BMX ($500)', value = 'bmx'},
				{label = 'Cruiser ($600)', value = 'cruiser'},
				{label = 'Fixter ($700)', value = 'fixter'},
				{label = 'Scorcher ($800)', value = 'scorcher'},
            }
        },
        function(data, menu)
