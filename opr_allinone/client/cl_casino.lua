...
positions = {
    ...
    {{930.35, 37.57, 81.1, 0}, {1090.00, 207.00, -49.9, 358},{255,0,0}, "Cassino Diamond"}, -- Outside the Sheriff's Station
    ...
    while true do
        ...
        for _,location in ipairs(positions) do
			...
			if CheckPos(playerLoc.x, playerLoc.y, playerLoc.z, loc1.x, loc1.y, loc1.z, 2) then 
				DrawText3Ds(loc1.x, loc1.y, loc1.z + 1.2, 'Press [~g~E~s~] To enter casino')
